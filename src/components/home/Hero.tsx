        ...
        <section className='w-10/12 mx-auto mb-10'>
            <main className='my-5 bg-gray-100 rounded-sm lg:gap-4 flex lg:flex-row flex-col lg:h-96 h-full items-center w-full px-6 py-4'>
                <div className="flex flex-col gap-4 lg:gap-6">
                    <h1 className='text-4xl md:text-7xl lg:text-6xl font-header font-bold'>Discover our <span className='text-accent'>shoes</span> </h1>
                    ...
                    <button className='bg-accent cursor-pointer hover:opacity-80 py-2 px-6 lg:w-60 lg:flex justify-center hidden text-white'>
                        <Link href={"/shoes"} className='flex w-full justify-center'>Shop Now</Link>
                    </button>
                </div>
                <Image src={shoe} className='lg:w-[700px] object-cover md:w-[500px] lg:h-[400px] h-full ' alt='' width={500} height={500} />
                <button className='bg-accent hover:opacity-80 cursor-pointer py-2 w-full md:w-80 justify-center lg:hidden flex text-white'>
                    <Link href={"/shoes"} className='flex w-full  justify-center'>Shop Now</Link>
                </button>
            </main>
        </section>
