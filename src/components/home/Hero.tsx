        ...
        <section className='w-10/12 mx-auto mb-10'>
            <main className='my-5 bg-gray-100 rounded-sm lg:gap-4 flex lg:flex-row flex-col lg:h-96 h-full items-center w-full px-6 py-4'>
                <div className="flex flex-col gap-4 lg:gap-6">
                    ...
                    <button className='bg-accent hover:opacity-80 py-2 px-6 lg:w-60 lg:flex justify-center hidden text-white'>
                ...
                <button className='bg-accent hover:opacity-80 py-2 px-8 md:w-80 justify-center lg:hidden flex text-white'>
                    <Link href={"/shoes"} className='flex w-full justify-center'>Shop Now</Link>
                </button>
            </main>
        </section>
